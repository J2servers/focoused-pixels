  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: `Aceitamos PIX, Boleto, Cartão de Crédito e Cartão de Débito. O parcelamento em até ${settings.installments}x sem juros está disponível para cartão de crédito.`,
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Trabalhamos com Acrílico, MDF, PVC, Vinil e Metal. Cada material tem características específicas e indicações de uso que nossa equipe pode orientar.',
        },
      ],
    },
    {
