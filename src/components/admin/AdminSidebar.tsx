...
function SidebarInner({
  ...
  return (
    <div className="h-full flex flex-col">
      {/* ── Logo Header ── */}
      <div className={cn(
        "h-[68px] flex items-center shrink-0 border-b border-white/[0.04]",
        ...
        {!collapsed && (
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 via-pink-500 to-blue-500 flex items-center justify-center shadow-lg">
        ...
        {collapsed && (
          <div className="relative">
            <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-violet-500 to-pink-500 blur-sm opacity-30" />
            <div className="relative w-9 h-9 rounded-lg bg-gradient-to-br from-violet-500 via-pink-500 to-blue-500 flex items-center justify-center">
        ...
        {!collapsed && (
          <Button
            ...
            className="shrink-0 text-white/20 hover:text-white hover:bg-white/[0.04] h-7 w-7 rounded-lg"
          >
      ...
      <ScrollArea className="flex-1">
        <nav className={cn("py-3", collapsed ? "px-2" : "px-3")}>
          {MENU_GROUPS.map(group => {
            ...
            // Collapsed mode: show items as flat icons
            if (collapsed) {
              return (
                <div key={group.label} className="mb-2">
                  ...
                  <Tooltip delayDuration={0}>
                    ...
                    <TooltipContent side="right" className="bg-[hsl(var(--admin-card))] text-white border-white/[0.08] text-xs font-semibold">
                      {group.label}
                    </TooltipContent>
                  </Tooltip>
                  {filteredItems.map(item => {
                    ...
                    return (
                      <Tooltip key={item.url} delayDuration={0}>
                        <TooltipTrigger asChild>
                          <NavLink
                            ...
                            className={cn(
                              ...
                              active
                                ? "bg-gradient-to-br from-violet-600 to-violet-500 text-white shadow-lg shadow-violet-500/25"
                        ...
                        <TooltipContent side="right" className="bg-[hsl(var(--admin-card))] text-white border-white/[0.08] text-xs font-medium">
                          {item.title}
                        </TooltipContent>
                      </Tooltip>
                    );
                      ...
                      return (
                        <NavLink
                          ...
                          className={cn(
                            ...
                            active
                              ? "bg-gradient-to-r from-violet-600/90 to-violet-500/90 text-white shadow-lg shadow-violet-500/20"
                        ...
                        >
                          ...
                          <item.icon className={cn(
                            ...
                            active && "drop-shadow-[0_0_6px_rgba(255,255,255,0.4)]",
      ...
      {/* ── Collapse Toggle (bottom, expanded only) ── */}
      {collapsed && (
          ...
          <Tooltip delayDuration={0}>
            <TooltipTrigger asChild>
              <Button
                ...
                className="w-full h-9 text-white/20 hover:text-white hover:bg-white/[0.04] rounded-xl"
              >
                <ChevronRight className="h-4 w-4" />
              </Button>
            </TooltipTrigger>
            <TooltipContent side="right" className="bg-[hsl(var(--admin-card))] text-white border-white/[0.08] text-xs">
              Expandir menu
            </TooltipContent>
          </Tooltip>
        </div>
      ...
      {/* ── User Footer ── */}
      <div className={cn(
        "border-t border-white/[0.04] shrink-0",
        collapsed ? "p-2" : "p-4"
      )}>
        {!collapsed && (
          <div className="mb-3 px-1">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-600 to-pink-500 flex items-center justify-center text-white text-xs font-bold shadow-lg shadow-violet-500/20 shrink-0">
        ...
        {collapsed ? (
          <Tooltip delayDuration={0}>
            ...
            <TooltipContent side="right" className="bg-[hsl(var(--admin-card))] text-white border-white/[0.08] text-xs">Sair</TooltipContent>
          </Tooltip>
        ) : (
          <Button
            variant="ghost"
    ...
    return (
      <>
        <Button
          ...
          className="fixed top-3 left-3 z-50 h-10 w-10 bg-[hsl(var(--admin-card))] text-white hover:bg-white/[0.08] shadow-xl border border-white/[0.06] rounded-xl"
        >
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          <SheetContent
            side="left"
            className="w-72 p-0 bg-[hsl(var(--admin-bg))] border-r border-white/[0.04]"
          >
  ...
  return (
    <aside
      className={cn(
        ...
        "bg-[hsl(var(--admin-bg))] border-r border-white/[0.04]",
