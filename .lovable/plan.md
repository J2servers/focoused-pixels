...
3. Adicionar JSON-LD WebSite com SearchAction (sitelinks search)
4. Adicionar JSON-LD LocalBusiness com endereço/telefone
...
17. Lazy loading com noscript fallback para imagens críticas
18. Preload de hero image (LCP)
...
24. Schema.org Review/Rating nas avaliações
25. Breadcrumb visual + schema em todas as páginas internas
...
32. Texto de preço responsivo (text-lg mobile, text-xl desktop)
...
49. Espaçamento consistente entre seções (py-8 mobile, py-16 desktop)
...
58. Track tempo na página
59. Track clique em WhatsApp
60. Track newsletter signup
61. Track checkout iniciado
62. Track checkout completado
63. Track abandono de carrinho (já existe hook)
64. Track clique em banner hero
65. Track uso de cupom
66. Track favoritar produto (wishlist)
67. Track visualização de produto (product view)
68. Track clique em "Ver todos" da categoria
69. Funnel de conversão: visit → product view → cart → checkout → payment
70. UTM params capture e storage
71. Referrer tracking
72. Device/browser tracking
73. Session duration tracking
74. Bounce rate tracking (single page visits)
75. Google Analytics 4 event structure ready

## ♿ Acessibilidade (25 itens)
76. Adicionar aria-label em todos os botões de ícone
77. Adicionar role="navigation" em navs
78. Adicionar role="main" no conteúdo principal
79. Adicionar role="banner" no header
80. Adicionar role="contentinfo" no footer
...
86. aria-expanded nos menus dropdown
...
91. role="alert" em mensagens de erro/toast
92. aria-live="polite" em contadores de carrinho
93. tabindex adequado em modais (trap focus)
94. Escape para fechar modais
95. lang="pt-BR" no html (já OK)
96. aria-label em links de redes sociais
97. Reduced motion media query (prefers-reduced-motion)
98. Screen reader text para preços (sr-only context)
99. Formulários com labels associados
100. Error messages vinculadas via aria-describedby

## Implementação Prioritária (Batch 1)
Itens de maior impacto: 3, 4, 6, 7, 14, 15, 19, 25, 49, 52-54, 56-57, 67, 76-82, 84-88, 96-97
